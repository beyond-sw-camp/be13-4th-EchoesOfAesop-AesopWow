...
| 조원<br>이름 | 회고 |
| --------- | --- |
| 유재우 | 몸이 좋지 않아서 수업을 꽤 빠져서 이해를 잘 못한 상태여서 팀원들에게 큰 도움을 못 줬지만 팀원들이 부족한 부분을 채워주고 이해 못한 부분을 알려주어 감을 잡고 이해할 수 있어서 팀원들에게 감사합니다!  |<br/>
| 권지민 | 처음에는 DevOps 환경 설정이 낯설고 복잡해서 시간이 좀 걸렸지만, 팀원들과 함께 머리를 맞대고 하나씩 문제를 해결할 수 있었다. |<br/>
| 송현준 | 쿠버네티스 환경이 낯설어서 이해하는데 많이 힘들었지만, 팀원들 모두 재밌는 분들이라 다함께 공부하며 작업할 수 있어서 즐거웠습니다. 다들 수고하셨습니다! |<br/>
| 염정운 | 솔직히 지금도 구조를 완전히 이해하지 못했다. 그래서 오히려 더 많은 공부를 하고자하는 의지가 생기는 시간이었다고 생각한다. |<br/>
| 이성훈 | 다들 DevOps를 처음 접해서 이해하고 배포하는 데 시간이 많이 걸렸지만, 짧은 시간 동안 각자 공부하고 문제를 해결하는 과정이 뿌듯하게 느껴졌습니다.|

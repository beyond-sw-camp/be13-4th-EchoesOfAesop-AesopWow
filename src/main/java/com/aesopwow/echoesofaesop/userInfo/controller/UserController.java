...
public interface UserController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "401", description = "UNAUTHORIZED - 인증되지 않은 사용자", content = @Content(mediaType = "application/json")),
            @ApiResponse(responseCode = "403", description = "FORBIDDEN - 해당 유저 정보를 찾을 수 없음", content = @Content(mediaType = "application/json")),
            @ApiResponse(responseCode = "500", description = "INTERNAL SERVER ERROR - 서버 오류 발생", content = @Content(mediaType = "application/json"))
    })
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "OK - 프로필 수정 성공", content = @Content(mediaType = "application/json")),
            @ApiResponse(responseCode = "400", description = "BAD REQUEST - 잘못된 요청 데이터", content = @Content(mediaType = "application/json")),
            @ApiResponse(responseCode = "401", description = "UNAUTHORIZED - 인증되지 않은 사용자", content = @Content(mediaType = "application/json")),
            @ApiResponse(responseCode = "403", description = "FORBIDDEN - 해당 유저 정보를 찾을 수 없음", content = @Content(mediaType = "application/json")),
            @ApiResponse(responseCode = "500", description = "INTERNAL SERVER ERROR - 서버 오류 발생", content = @Content(mediaType = "application/json"))
    })
